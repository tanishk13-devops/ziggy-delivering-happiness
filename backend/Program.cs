...
static void SeedRestaurants(FoodDeliveryDbContext context)
{
    var catalog = new List<(string Name, string Description, string Location, decimal Rating, string ImageUrl)>
    {
        ...
        ("Tandoor Tales", "Signature kebabs, curries, and handcrafted breads.", "Delhi Connaught Place", 4.5m, "https://images.unsplash.com/photo-1599487488170-d11ec9c172f0?q=80&w=1200"),
        ...
        ("Roll Republic", "Kathi rolls, wraps, and quick bites.", "Kolkata Park Street", 4.1m, "https://images.unsplash.com/photo-1628102476695-8d4b35e0b54f?q=80&w=1200"),
